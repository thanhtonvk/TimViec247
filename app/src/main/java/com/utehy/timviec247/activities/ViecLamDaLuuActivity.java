...
public class ViecLamDaLuuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viec_lam_da_luu);
        init();
        load();
    }
    ...
    private void load() {
        ...
        database.getReference("LuuCV").child(Common.account.getId()).addValueEventListener(new ValueEventListener() {
            @Override
